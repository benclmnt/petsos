            ...
            <div className="mx-48 mt-20 text-left">
                ...
                <form>
                    <label>
                        ...
                        <input type="text" name="name" className="border-gray-400 border-2 h-full w-full rounded-md p-1" /><br/>
                    </label>
                    <label>
                        <p className="mt-2 font-semibold">Address Line 2</p>
                        <input type="text" name="name" className="border-gray-400 border-2 w-full rounded-md p-1" /><br/>
                    </label>
                    ...
                    <label>
                        ...
                        <input type="text" name="name" className="border-gray-400 border-2 rounded-md p-1" />
                    </label>
